	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            ...
	                            <?php echo $this->session->flashdata('error_message'); ?>
	                                <form method="post" action="<?php echo base_url('user/change_password_handler');?>">
	                                    <div class="row">
	                                        <div class="col-md-12">
	                                        <a href="<?php echo base_url('user/profile');?>">Back to Edit Profile</a>
	                                        ...
	                                        <div class="col-md-12">
	                                         ...
	                                         <div class="col-md-12">
												<div class="form-group label-floating">
													...
													<input name="cnewpassword" required type="password" class="form-control" >
												</div>
	                                        </div>
	                                        <div class="col-md-4">
	                                        </div>
