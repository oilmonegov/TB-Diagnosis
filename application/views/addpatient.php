...
<head>
    ...
    <link href="<?php echo base_url('bootstrap-datepicker/dist/css/bootstrap-datepicker.css'); ?>" rel="stylesheet" />
			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="<?php echo base_url('user/dashboard'); ?>">Add Patient</a>
					</div>
	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title"><i class="fa fa-user"></i> Add Patient</h4>
									<p class="category">Enter Patient's BioData</p>
	                            </div>
	                            <div class="card-content">
	                            <?php echo $this->session->flashdata('error_message'); ?>
	                                <form method="post" action="<?php echo base_url('user/add_patient_handler');?>">
	                                    <div class="row">
	                                        <div class="col-md-12">
	                                        ...
	                                        <div class="col-md-12">
												<div class="form-group label-floating">
													...
													<input name="othernames" required type="text" class="form-control" >
												</div>
	                                        </div>
	                                         <div class="col-md-12">
												<div class="form-group label-floating">
	                                        ...
	                                        <div class="col-md-12">
												<div class="form-group label-floating">
													...
													<input name="mobile_number" required type="text" maxlength="11" minlength="11" class="form-control" >
												</div>
	                                        </div>
	                                         <div class="col-md-12">
												<div class="form-group label-floating">
													<label class="control-label">Date of Birth (YYYY-M-d)</label>
													<input name="birth_date" required type="text" class="form-control" >
												</div>
	                                        </div>
	                                        <div class="col-md-12">
												<div class="form-group label-floating">
