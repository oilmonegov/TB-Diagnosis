			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="<?php echo base_url('user/dashboard'); ?>">Add Staff</a>
					</div>
	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title"><i class="fa fa-user"></i> Add Staff</h4>
									<p class="category">Enter Staff's Details</p>
	                            </div>
	                            <div class="card-content">
	                            <?php echo $this->session->flashdata('error_message'); ?>
	                                <form method="post" action="<?php echo base_url('user/add_staff_handler');?>">
	                                    <div class="row">
	                                        <div class="col-md-12">
	                                        ...
	                                        <div class="col-md-12">
												<div class="form-group label-floating">
													...
													<input name="username" required type="text" minlength="5" class="form-control" >
												</div>
	                                        </div>
	                                          <div class="col-md-12">
												<div class="form-group label-floating">
													<label class="control-label">Password</label>
													<input name="password" required type="password" minlength="6" class="form-control" >
												</div>
	                                        </div>
	                                         <div class="col-md-12">
												<div class="form-group label-floating">
													<label class="control-label">Confirm Password</label>
													<input name="cpassword" required type="password" minlength="6" class="form-control" >
												</div>
	                                        </div>
	                                        <div class="col-md-4">
	                                        </div>
